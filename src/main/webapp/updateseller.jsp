...
<body>
	...
	<form action="upprofile" method="post" style=" width: 50vw; margin-left : 25vw;">
	<table>
		<tr>
		...
		<tr>
			<td>Email<input type="email" name="email" value="<%= email %>" > </td>
		</tr>
		<tr>
			<td>Phone<input type="text" name="phone" value="<%= phone %>" ></td>
		</tr>
		<tr>
			<td>User Name<input type="text" name="uname" value="<%= username %>" ></td>
		</tr>
		<tr>
			<td>Password<input type="password" name="pass" value="<%= password %>" ></td>
		</tr>
		<tr>
			<td>Category<input type="text" name="category" value="<%=category %>" ></td>
		</tr>
		<tr>
			<td><input type="submit" name="submit" value="Update MY Profile"></td>
		</tr>
